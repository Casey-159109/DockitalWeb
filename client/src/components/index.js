    ...
    return(
      <form className="form p-2" onSubmit={onSubmit}>
        <div className="form_body d-flex justify-content-between flex-column">
          <div>
              <input placeholder="Name" className="form-control mb-2"  type="text" name="name" ref={ref} onChange={onChange}/>
              <input className="form-control mb-2"  type="file" name="file" ref={ref} onChange={onChange}/>
              <input placeholder="Price in wei" className="form-control mb-2"  type="text" name="price" ref={ref} onChange={onChange}/>
          </div>
